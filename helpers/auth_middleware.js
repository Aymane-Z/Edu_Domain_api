        ...
        if (req.user) {
            ...
            switch(roleName) {
				case 'admin':
					req.isAdmin = true;
					break;
				case 'responsable_residence':
					req.isResponsableResidence = true;
					break;
				case 'client':
					req.isClient = true;
					break;
				case 'caissier':
					req.isCaissier = true;
					break;
				case 'hotesse_accueil':
					req.isHotesseAccueil = true;
					break;
				case 'superviseur_securite':
					req.isSuperviseurSecurite = true;
					break;
				case 'charge_clientele':
					req.isChargeClientele = true;
					break;
				case 'responsable_technique':
					req.isResponsableTechnique = true;
					break;
				case 'client_temp':
					req.isClientTemp = true;
					break;
				default:
					req.isGuest = true;
			}
