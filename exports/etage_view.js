...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Nombre Chambres", key: "nombre_chambres" },
				{ header: "Acces Handicape", key: "acces_handicape" },
				{ header: "Amenagements Speciaux", key: "amenagements_speciaux" },
				{ header: "Id Pavillon", key: "id_pavillon" },
				{ header: "Date Created", key: "date_created" },
				{ header: "Date Updated", key: "date_updated" }
		]
		let filename = utils.dateNow() + "etageview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Etage Details");
