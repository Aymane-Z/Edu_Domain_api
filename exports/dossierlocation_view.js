...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				{ header: "Id", key: "id" },
				{ header: "Dt Effet", key: "dt_effet" },
				{ header: "Id Client", key: "id_client" },
				{ header: "Id Unite Location", key: "id_unite_location" },
				{ header: "Id Contrat", key: "id_contrat" },
				{ header: "Date Created", key: "date_created" },
				{ header: "Date Updated", key: "date_updated" }
		]
		let filename = utils.dateNow() + "dossierlocationview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Dossier Location Details");
			...
			let page = "dossierlocationview.ejs";
