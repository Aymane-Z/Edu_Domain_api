...
async function exportViewPage(records, req, res) {
	try{
		...
		let filename = utils.dateNow() + "familleequipementview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Famille Equipement Details");
			...
			let page = "familleequipementview.ejs";
