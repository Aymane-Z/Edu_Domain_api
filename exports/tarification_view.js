...
async function exportViewPage(records, req, res) {
	try{
		...
		let filename = utils.dateNow() + "tarificationview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Tarification Details");
