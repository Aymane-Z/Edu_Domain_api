...
async function exportViewPage(records, req, res) {
	try{
		...
		let filename = utils.dateNow() + "unitelocationdetailsview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Unitelocationdetail Details");
			...
			let page = "unitelocationdetailsview.ejs";
