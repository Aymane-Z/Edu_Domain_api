...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Compte Bancaire", key: "compte_bancaire" },
		...
		let filename = utils.dateNow() + "garantview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Garant Details");
