...
async function exportListPage(records, req, res) {
		try{
			...
			let columns =  [
				...
				{ header: "Categoriechambre", key: "categoriechambre" },
				{ header: "Id Typech", key: "id_typech" },
				{ header: "Id Residence", key: "id_residence" }
		]
		let filename = "freerentalunitslist-report";

		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Freerentalunits");
			...
			let page = "freerentalunitslist.ejs";
