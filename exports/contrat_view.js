...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				{ header: "Id", key: "id" },
				{ header: "Ref Contrat", key: "ref_contrat" },
				{ header: "Date", key: "date" },
				{ header: "Observation", key: "observation" },
				{ header: "Remise", key: "remise" },
				{ header: "Franchize", key: "franchize" },
				{ header: "Date Created", key: "date_created" },
				{ header: "Date Updated", key: "date_updated" }
		]
		let filename = utils.dateNow() + "contratview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Contrat Details");
