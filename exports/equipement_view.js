...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Dt Acquisition", key: "dt_acquisition" },
				{ header: "Valeur", key: "valeur" },
				{ header: "Etat Physique", key: "etat_physique" },
				{ header: "Observation", key: "observation" },
				{ header: "Id Famille Equipement", key: "id_famille_equipement" },
				{ header: "Id Unite Location", key: "id_unite_location" }
		]
		let filename = utils.dateNow() + "equipementview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Equipement Details");
