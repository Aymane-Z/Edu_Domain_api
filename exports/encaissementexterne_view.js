...
async function exportViewPage(records, req, res) {
	try{
		...
		let filename = utils.dateNow() + "encaissementexterneview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Encaissement Externe Details");
			...
			let page = "encaissementexterneview.ejs";
