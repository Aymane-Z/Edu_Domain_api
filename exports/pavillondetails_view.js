...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Nombre Entrees", key: "nombre_entrees" },
				{ header: "Dt Mise Service", key: "dt_mise_service" },
				{ header: "Id Batiment", key: "id_batiment" },
				{ header: "B Denomination", key: "b_denomination" },
				{ header: "Id Residence", key: "id_residence" },
				{ header: "R Denomination", key: "r_denomination" },
				{ header: "Id Responsable", key: "id_responsable" },
				{ header: "Id Proprietaire", key: "id_proprietaire" },
				{ header: "P Denomination", key: "p_denomination" },
				{ header: "Nom Prenom", key: "nom_prenom" }
		]
		let filename = utils.dateNow() + "pavillondetailsview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Pavillondetail Details");
			...
			let page = "pavillondetailsview.ejs";
