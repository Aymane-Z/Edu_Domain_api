...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Mois Consommation", key: "mois_consommation" },
				{ header: "Index Eau Froid", key: "index_eau_froid" },
				{ header: "Index Eau Chaud", key: "index_eau_chaud" },
				{ header: "Index Electricite", key: "index_electricite" },
		...
		let filename = utils.dateNow() + "lecturedesindexview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Lecture Des Index Details");
			...
			let page = "lecturedesindexview.ejs";
