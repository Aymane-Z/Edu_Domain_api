...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Dt Facture", key: "dt_facture" },
				{ header: "Id Facturation", key: "id_facturation" },
				{ header: "Date Created", key: "date_created" },
				{ header: "Date Updated", key: "date_updated" }
		]
		let filename = utils.dateNow() + "factureview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Facture Details");
