...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				{ header: "Id", key: "id" },
				{ header: "Dt Facturation", key: "dt_facturation" },
		...
		let filename = utils.dateNow() + "facturationview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Facturation Details");
