...
async function exportViewPage(records, req, res) {
	try{
		...
		let columns =  [
				...
				{ header: "Id Dossierlocation", key: "id_dossierlocation" },
				...
				{ header: "Date Resolue", key: "date_resolue" }
		]
		let filename = utils.dateNow() + "reclamationview-report";
		if(format == "excel"){
			let workbook = new excel.Workbook();
			let worksheet = workbook.addWorksheet("Reclamation Details");
